...
const CoverLetter = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-gray-900 font-sans pb-32 animate-fade-in">
      ...
      <main className="max-w-4xl mx-auto px-6 pt-16">
        <div className="mb-16">
          <div className="inline-block px-4 py-2 bg-blue-50 text-blue-700 rounded-full text-sm font-bold mb-4">
            Cover Letter
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-gray-900">자기소개서</h1>
        </div>

        <div className="space-y-20 bg-white p-8 md:p-12 rounded-[2rem] shadow-sm border border-gray-100">
          ...
          <section>
            ...
            {/* 시각화 이미지 삽입 영역 */}
            <div className="w-full bg-gray-50 rounded-2xl overflow-hidden border border-gray-200 flex flex-col items-center justify-center relative aspect-video mb-8 group cursor-pointer hover:bg-gray-100 transition-colors">
              <img 
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/5">
                <div className="bg-white/90 backdrop-blur px-6 py-3 rounded-full font-bold text-gray-600 shadow-sm text-sm flex items-center gap-2 border border-gray-200">
                  <ImageIcon size={18} />
                  <span>이곳에 강점/단점 시각화 이미지를 교체해 주세요.</span>
                </div>
              </div>
            </div>
  ...
  const projects = [
    {
      ...
      detailImages: ['/api/placeholder/1200/800', '/api/placeholder/1200/800'],
      color: 'bg-purple-50'
    },
    {
      id: 2,
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-gray-900 font-sans selection:bg-black selection:text-white pb-20">
      ...
      <main className="max-w-6xl mx-auto px-6 pt-32">
        ...
        {/* 히어로(Hero) 섹션 */}
        <section className="mt-16 md:mt-24 mb-32 animate-fade-in-up">
          <div className="inline-block px-4 py-2 bg-blue-50 text-blue-700 rounded-full text-sm font-bold mb-6">
            UI/UX & Web Designer
          </div>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-[1.15] tracking-tight mb-8 text-gray-900 break-keep">
            배려를 디자인하는<br/>
            디자이너 <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">변영완</span>입니다.
          </h1>
          <p className="text-lg md:text-xl text-gray-500 leading-relaxed mb-10 max-w-2xl break-keep font-medium">
            밀키트 스타트업 '푸드어셈블'에서 2년 8개월간 웹디자이너로 일하며 많은 것을 배우고 경험했습니다. 
            단순한 디자인을 넘어 사용자의 맥락을 이해하고 명확한 경험을 설계하며, 새로운 모험을 향해 나아가고 있습니다.
          </p>
          <div className="flex flex-wrap gap-4">
            <a href="#work" className="bg-black text-white px-8 py-4 rounded-full font-bold hover:bg-gray-800 transition-transform hover:-translate-y-1 inline-flex items-center gap-2">
              포트폴리오 보기 <ArrowUpRight size={18} />
            </a>
            {/* 자기소개서 페이지 이동 버튼 */}
            <button 
              onClick={handleNavigateToCoverLetter}
              className="bg-white border-2 border-gray-200 text-gray-800 px-8 py-4 rounded-full font-bold hover:border-gray-300 hover:bg-gray-50 transition-colors inline-flex items-center gap-2 cursor-pointer"
            >
              저에 대해 더 알아보기
            </button>
          </div>
              ...
              <div>
                ...
                <div className="border-l-2 border-blue-100 ml-2 mb-12 flex flex-col gap-10 py-1">
                  ...
                  <div className="relative pl-6">
                    ...
                    <p className="text-sm text-blue-600 font-bold mb-4">2019.10 - 2022.06 (2년 8개월)</p>
                  ...
                  <div className="relative pl-6">
                    ...
                    <h3 className="text-xl font-bold mb-1">(주)우신 <span className="text-base font-medium text-gray-400 ml-2">패키지디자인 · 사원</span></h3>
                    <p className="text-sm text-gray-500 font-bold mb-4">2018.07 - 2018.09 (3개월)</p>
                    <ul className="list-disc list-inside text-gray-600 space-y-2 font-medium">
                      <li>패키지 디자인 업무 보조 및 실무 진행</li>
                    </ul>
                  </div>
          ...
          >
            ...
            <div className="overflow-y-auto p-6 md:p-10 custom-scrollbar flex-1">
              ...
              <div className="mb-10 text-center md:text-left flex flex-col md:items-start items-center">
                <div className="text-sm font-bold text-blue-600 mb-4 uppercase tracking-wider px-4 py-1 bg-blue-50 rounded-full inline-block">
